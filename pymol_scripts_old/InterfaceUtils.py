...
def loadInterfacePDB(filename,name=None, native=None):
    """
    loadInterfacePDB file <name> <native name>

    Load interface pdb coloring by chain and showing interface features.
    """
    print "Loading interface PDB %s" % filename
...
cmd.extend("colorInterface",colorInterface)
